...
<p align="center">
  <b>ZeyronAC</b> — a server-side anti-cheat plugin for Minecraft servers utilizing external, asynchronous server-side data processing.
  <br>
...
| **FAST & PRO Models** | FAST model handles instant detections, while the PRO model focuses on deep behavioral analysis. |
